...
def plot_miss_graphic(y_ticks, path_to_csv=".", filename="problem1_py", out_path='.', title="", format="csv", scale='linear'):
...
if problem2:
    scaleLimits = [0, 500000.0, 4000000.0] if compilacao == 'O0' else [0, 240000.0, 1200000.0]
...
if problem3:
    scaleLimits = [0, 12000000.0, 60000000.0] if compilacao == 'O0' else [0, 800000.0, 4000000.0]
